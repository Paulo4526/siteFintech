...
<body class="bg-dark">
    ...
    <main class="mb-5">
		...
		<p>Infelizmente você não conseguiu realizar seu cadastro! Verifique seu Email e CPF, caso ja esteja cadastrado entre em contato conosco! Clique <a href="cadastro.jsp">aqui</a> para tentar novamente!</p>
        <!-- Login com as redes sociais início -->
