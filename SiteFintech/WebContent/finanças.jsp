...
<body class="bg-dark">
    ...
    <section class="container-fluid text-center text-light" id="cardElement">
          <div class="row">
            <div class="col-6 mt-5">GASTOS</p>
              <a href="gastos.jsp"><img src="assets/img/PLANILHA.jpg" class="border-light border border-3 rounded figure" alt="GASTOS"></a>
            </div>
  
            <div class="col-6 mt-5"><p>INVESTIMENTO</p>
               <a href="investimento.jsp"><img src="assets/img/PLANILHA.jpg" class="border-light border border-3 rounded figure" alt="INVESTIMENTO(RENDA VARIAVEL)"></a>
            </div>

            <div class="col-6 mt-5"><p>PROVENTOS/LUCRO</p>
              <a href="proventos.jsp"><img src="assets/img/PLANILHA.jpg" class="border-light border border-3 rounded figure" alt="PROVENTOS/LUCRO"></a>
            </div>
          </div>
        </div>
    </section>
