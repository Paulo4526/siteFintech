...
<body class="bg-dark">
    ...
    <header class="grid fixed-top">
        <div class="logo">
            <a href="../../index.html" class="logo-link"><img src="assets/img/logo_my_Finance-removebg-preview.png"alt="Logo My Finance"></a>
        </div>
	...
	<div class="alert text-center alert-danger"> ${erro}</div>
        ...
        <input type="hidden" value="cadastrar" name="acao"/>
            <div class="container new-form text-light">
                ...
                <div class="mb-3">
                    <label for="dsGasto" class="form-label">Tipo de Gasto</label>
                    <input type="text" name="dsGasto" class="form-control" placeholder="Ex: Mercado, Mêcanica, Peça e etc." maxlength="30" required>
                    <i class="fa-solid fa-user-tie icon"></i>
                </div>

                <div class="mb-3">
                    <label for="vlGasto" class="form-label">Valor</label>
                    <input type="number" name="vlGasto" class="form-control" placeholder="Ex: 1588.60" maxlength="9" required>
                    <i class="fa-solid fa-user icon"></i>
                </div>

                <div class="mb-3">
                    <label for="dtGasto" class="form-label">Data do Gasto</label>
                    <input type="date" class="form-control" name="dtGasto" required>
                ...
                <button type="submit" class="btn btn-primary">Cadastrar Gastos</button>
                <a class="btn btn-primary" href="gastos.jsp">Voltar</a>
            </div>
        </form>
    </section>
    <!-- fim cards -->
