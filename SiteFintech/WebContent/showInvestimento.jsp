...
<body class="bg-dark">
	...
	<div class="alert text-center alert-danger"> ${erro}</div>
        ...
        <div class="finance-content">
        	<c:forEach items="${cadInvestimento}" var="p">
		        <div class="finance-table">
		            <div class="header-finance">
		                <div class="fiance-action">
		                    <c:url value="cadInvestimento" var="link">
							<c:param  name="codigo" value="${p.cdInvestimento}"/>
							<c:param name="acao" value="editar"/>
							</c:url>
							<p class="edit"><a class="" href="${link}"><i class="fa-solid fa-pen icon"></i></i></a></p>
		                    <p class="delete"><button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#exampleModal" onclick= "codigoExcluir.value = ${p.cdInvestimento}">
		            ...
		            <div class="header-finance">
		                ...
		                <div class="fiance-description">
		                    <p class="left">${p.cdInvestimento}</p>
		                    <p class="right">${p.dsInvestimento}</p>
		                </div>
		            </div>
		            ...
		            <div class="header-finance">
		                ...
		                <div class="fiance-description">
		                    <p class="left">${p.vlInvestimento}</p>
		                    <p class="right">${p.dtInvestimento}</p>
		                </div>
		            </div>
					  ...
					  <div class="modal-dialog">
					    <div class="modal-content">
					      ...
					      <div class="modal-footer">
					        <form action="cadInvestimento" method="post">
		...
		<div class="add">
		<a href="cadInvestimento.jsp" class="btn btn-primary">Adicionar</a>
		</div>
    </section>
    <!-- fim cards -->
