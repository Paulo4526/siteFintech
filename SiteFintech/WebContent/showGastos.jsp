...
<body class="bg-dark">
	...
	<div class="alert text-center alert-danger"> ${erro}</div>
        ...
        <div class="finance-content">
        	<c:forEach items="${cadGasto}" var="p">
		        <div class="finance-table">
		            <div class="header-finance">
		                <div class="fiance-action">
		                    <c:url value="cadGasto" var="link">
							<c:param  name="codigo" value="${p.cdGasto}"/>
							<c:param name="acao" value="editar"/>
							</c:url>
							<p class="edit"><a class="" href="${link}"><i class="fa-solid fa-pen icon"></i></i></a></p>
		                    <p class="delete"><button type="button" class="btn" data-bs-toggle="modal" data-bs-target="#exampleModal" onclick= "codigoExcluir.value = ${p.cdGasto}">
		            ...
		            <div class="header-finance">
		                ...
		                <div class="fiance-description">
		                    <p class="left">${p.cdGasto}</p>
		                    <p class="right">${p.dsGastos}</p>
		                </div>
		            </div>
		            ...
		            <div class="header-finance">
		                ...
		                <div class="fiance-description">
		                    <p class="left">${p.vlGastos}</p>
		                    <p class="right">${p.dtGasto}</p>
		                </div>
		            </div>
					  ...
					  <div class="modal-dialog">
					    <div class="modal-content">
					      ...
					      <div class="modal-footer">
					        <form action="cadGasto" method="post">
		...
		<div class="add">
		<a href="cadGasto.jsp" class="btn btn-primary">Adicionar</a>
		</div>
    </section>
    <!-- fim cards -->
