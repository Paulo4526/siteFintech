...
<head>
    ...
    <title>Cadastrar Proventos</title>
</head>
<body class="bg-dark">
    <!-- inicio cabecalho -->
        ...
        <form class="form needs-validation" action="cadProv" method="post" novalidate>
            ...
            <div class="container new-form text-light">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="dsProventos" class="form-control" placeholder="Ex: Mercado, Mêcanica, Peça e etc." maxlength="30" required>
                    <i class="fa-solid fa-user-tie icon"></i>
                </div>

                <div class="mb-3">
                    <label for="vlProventos" class="form-label">Valor</label>
                    <input type="number" name="vlProventos" class="form-control" placeholder="Ex: 1588.60" maxlength="9" required>
                    <i class="fa-solid fa-user icon"></i>
                </div>

                <div class="mb-3">
                    <label for="dtProventos" class="form-label">Data do Recebimento</label>
                    <input type="date" class="form-control" name="dtProventos" required>
                ...
                <button type="submit" class="btn btn-primary">Cadastrar Proventos</button>
                <a class="btn btn-primary" href="proventos.jsp">Voltar</a>
            </div>
        </form>
    </section>
    <!-- fim cards -->
