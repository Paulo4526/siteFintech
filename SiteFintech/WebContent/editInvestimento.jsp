...
<head>
    ...
    <title>Editar Investimentos</title>
</head>
<body class="bg-dark">
    <!-- inicio cabecalho -->
	...
	<div class="alert text-center alert-danger"> ${erro}</div>
        ...
        <form class="form needs-validation" action="cadInvestimento" method="post" novalidate>
            <div class="container new-form text-light">
				...
				<input type="hidden" value="${cadInvestimento.cdInvestimento}" name="codigo"/>

                <input type="hidden"  name="cpf" class="form-control" aria-describedby="emailHelp" placeholder="Ex:41558965430"  maxlength="11" minlength="11" required autofocus value="${cadInvestimento.cpf}">

                <div class="mb-3">
                    <label for="dsProventos" class="form-label">Tipo de Proventos</label>
                    <input type="text" name="dsIvestimento" class="form-control" placeholder="Ex: Mercado, Mêcanica, Peça e etc." maxlength="30" required value="${cadInvestimento.dsInvestimento}">
                    <i class="fa-solid fa-user-tie icon"></i>
                </div>

                <div class="mb-3">
                    <label for="vlProventos" class="form-label">Valor</label>
                    <input type="number" name="vlInvestimento" class="form-control" placeholder="Ex: 1588.60" maxlength="9" required value="${cadInvestimento.vlInvestimento}">
                    <i class="fa-solid fa-user icon"></i>
                </div>

                <div class="mb-3">
                    <label for="dtProventos" class="form-label">Data do Recebimento</label>
                    <input type="date" class="form-control" name="dtInvestimento" required value="${cadInvestimento.dtInvestimento}">
                    <i class="fa-solid fa-cake-candles icon"></i>
                </div>

                <div class="mb-3">
                    <label for="dsAdicionais" class="form-label">Informações Adiconais</label>
                    <input type="text" class="form-control" name="dsAdicionais" placeholder="EX: gastos com carro" maxlength="30" required value="${cadInvestimento.dsAdicionais}">
                    <i class="fa-solid fa-key icon"></i>
                </div>   

                <button type="submit" class="btn btn-primary">Salvar Mudanças</button>
                <a href="cadInvestimento?acao=listar" class="btn btn-danger">Cancelar</a>
