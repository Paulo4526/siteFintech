...
<body class="bg-dark">
    ...
    <section class="container-fluid text-center text-light" id="cardElement">
          <div class="row">
            <div class="col-6 mt-5">CADASTRAR GASTOS</p>
              <a href="cadGasto.jsp"><img src="assets/img/PLANILHA.jpg" class="border-light border border-3 rounded figure" alt="GASTOS"></a>
            </div>

            <div class="col-6 mt-5"><p>MEUS GASTOS</p>
              <a href="cadGasto?acao=listar"><img src="assets/img/PLANILHA.jpg" class="border-light border border-3 rounded figure" alt="PROVENTOS/LUCRO"></a>
            </div>
          </div>
        </div>
    </section>
